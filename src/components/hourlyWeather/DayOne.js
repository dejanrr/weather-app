    ...
    <div className="hourly-weather-wrapper">
      ...
      <div className="hourly-weather-row">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[4].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[6].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[10].temp_c}°
          </div>
        </div>
      </div>
      ...
      <div className="hourly-weather-row">
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[12].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[16].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[18].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[0].hour[22].temp_c}°
          </div>
        </div>
      </div>
    </div>
