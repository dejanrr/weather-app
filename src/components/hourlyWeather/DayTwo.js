    ...
    <div className="hourly-weather-wrapper">
      ...
      <div className="hourly-weather-row">
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[0].condition.icon} />
          </div>
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[1].hour[0].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[2].condition.icon} />
          </div>
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[1].hour[2].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[4].condition.icon} />
          </div>
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[1].hour[4].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[6].condition.icon} />
          </div>
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[1].hour[6].temp_c}°
          </div>
        </div>
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[8].condition.icon} />
          </div>
          <div className="hourly-weather-value">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[10].condition.icon} />
          </div>
          <div className="hourly-weather-value">
      ...
      <div className="hourly-weather-row">
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[12].condition.icon} />
          </div>
          <div className="hourly-weather-value">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[14].condition.icon} />
          </div>
          <div className="hourly-weather-value">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[16].condition.icon} />
          </div>
          <div className="hourly-weather-value">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[18].condition.icon} />
          </div>
          <div className="hourly-weather-value">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[20].condition.icon} />
          </div>
          <div className="hourly-weather-value">
        ...
        <div className="week-box">
          ...
          <div className="hourly-weather-icon">
            <img src={weather.forecast.forecastday[1].hour[22].condition.icon} />
          </div>
          <div className="hourly-weather-value">
            {weather.forecast.forecastday[1].hour[22].temp_c}°
          </div>
        </div>
      </div>
    </div>
